(async function () {
  ...
  container.innerHTML = `
    <div style="display: flex; align-items: center; justify-space-between; justify-content: space-between; padding: 10px 14px; border-bottom: 1px solid ${isLight ? '#d0d7de' : '#30363d'}; background-color: ${isLight ? '#f6f8fa' : '#161b22'};">
